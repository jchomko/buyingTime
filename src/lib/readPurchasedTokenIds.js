 ...
 * Uses BuyingTime.getSoldTokenOwners() (parallel tokenIds + owners arrays).
 ...
 */
export async function readPurchasedTokenIds({ rpcUrl, contractAddress }) {
  ...
  try {
    ...
    throw new Error(`getSoldTokenOwners failed: ${msg}`)
  }
}
